...
CARDS_JS = r"""const CARDS = [
  ...
  {cls:"ccard", html:`<div class="ek">What it did &middot; space</div>
    <h2>Real&#8209;time, all the way to orbit</h2>
    ...
    <ul class="blist">
      <li><b>MASSCOMP</b>&rsquo;s real&#8209;time computers flew with the <b>Space Shuttle</b> program</li>
      <li>In <b>1988</b>, MASSCOMP became part of <b>Concurrent</b> &mdash; the 3280&rsquo;s company</li>
      <li>The same job as this machine: real&#8209;time, when milliseconds matter</li>
    </ul>
    <div class="morep">Footage: NASA (public domain) &middot; space link via MASSCOMP, joined Concurrent 1988</div>`},
